import { Omit } from "@gerhobbelt/ast-types/types";
...
export interface Options extends DeprecatedOptions {
  /**
   * If you want to use a different branch of babylon, or any other module
   ...
   */
  extraLineBreaksForMultilineProperty?: boolean;
